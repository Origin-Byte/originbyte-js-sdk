...
/home/aldrin/Code/laminar/tests/airdrop-coin.sh --to "${sui_addr}" --amount 500000 --cont ${container} 1>/dev/null
/home/aldrin/Code/laminar/tests/airdrop-coin.sh --to "${sui_addr}" --amount 1000000 --cont ${container} 1>/dev/null

sed -i "34s/.*/const TEST_USER: address = @${sui_addr};/" __tests__/assets/testract/sources/main.move
