...
import {
  ...
  buildCollectRoyaltiesTx,
  buildDistributeRoyaltiesTx,
} from "./txBuilders";
import {
  ArtNft,
...
export class NftClient {
  ...
  static buildCollectRoyaltiesTx = buildCollectRoyaltiesTx;

  static buildDistributeRoyaltiesTx = buildDistributeRoyaltiesTx;
